...
export default function MPListCard() {
    return (
        <Card className="w-64 bg-gray-50 border border-gray-200 shadow-md overflow-hidden">
            <div className="bg-gray-200 p-2 text-center">
                <span className="text-sm font-bold text-gray-700 bg-white px-2 py-1 rounded">SS (UBT)</span>
            </div>
            <CardContent className="p-4">
                <div className="flex flex-col items-start space-y-3">
                    ...
                    <div className="space-y-0.5 w-full text-sm">
                        <p className="text-gray-600 font-medium">Maharashtra</p>
                        <p className="text-gray-500">Hingoli</p>
                        <p className="text-gray-500">52 years old</p>
